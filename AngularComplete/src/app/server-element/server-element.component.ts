...
/* 
  ...
  * View Encapsulation - View encapsulation ih angular is like we have right now css which says that text inside <p> should be in blue 
    ...
    Now we might see that it's in the app components. As files so clearly it only belongs to this template.But Because the way C S S works it doesn't really care in which C S S fall.
